  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-slate-900">
      <div className="mx-auto flex max-w-lg flex-col items-center justify-center rounded-lg bg-white p-8 text-center shadow-lg dark:bg-slate-800">
        ...
        <a
          href="/"
          className="inline-flex items-center rounded-md border border-transparent bg-sky-600 px-4 py-2 text-sm font-medium text-white hover:bg-sky-700 focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:outline-none"
        >
